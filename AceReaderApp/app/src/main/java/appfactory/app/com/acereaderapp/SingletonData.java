...
//    }
    ...
    public static void setScore(int score) {
        SingletonData.score = score;
    }

    public static int getCurrent_question() {
        return current_question;
    }

    public static void setCurrent_question(int current_question) {
        SingletonData.current_question = current_question;
    }
}
